...
Vue Test Utils là thư viện chính thức hỗ trợ unit test cho Vue.js.

- [Hướng dẫn](./guides/)
  - [Bắt đầu](./guides/getting-started.md)
  - [Kỹ thuật phổ biến](guides/common-tips.md)
  - [Test Key, Mouse và các DOM event](guides/dom-events.md)
  ...
  - [Sử dụng với TypeScript](guides/using-with-typescript.md)
  - [Sử dụng với Vue Router](guides/using-with-vue-router.md)
  - [Sử dụng với Vuex](guides/using-with-vuex.md)
- [API](api/)
  - [mount](api/mount.md)
