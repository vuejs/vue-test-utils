...
function getSelectorType (selector) {
  if (isDomSelector$1(selector)) {
    return DOM_SELECTOR
  }

  if (isNameSelector$1(selector)) {
    return NAME_SELECTOR
  }

  if (isVueComponent$2(selector)) {
    return COMPONENT_SELECTOR
  }

  if (isRefSelector$1(selector)) {
    return REF_SELECTOR
  }
}
...
function createFunctionalSlots$1 (slots, h) {
  ...
  Object.keys(slots).forEach(function (slotType) {
    if (Array.isArray(slots[slotType])) {
      ...
      if (!isValidSlot$1$1(slots[slotType])) {
        throwError$1('slots[key] must be a Component, string or an array of Components');
      }
...
function assignValue$1(object, key, value) {
  var objValue = object[key];
  if (!(hasOwnProperty$4$1.call(object, key) && eq_1$1(objValue, value)) ||
      (value === undefined && !(key in object))) {
...
/** Built-in value references. */
var propertyIsEnumerable$2 = objectProto$6$1.propertyIsEnumerable;
...
var isArguments$1 = _baseIsArguments$1(function() { return arguments; }()) ? _baseIsArguments$1 : function(value) {
  return isObjectLike_1$1(value) && hasOwnProperty$5$1.call(value, 'callee') &&
...
function arrayLikeKeys$1(value, inherited) {
  ...
  for (var key in value) {
    if ((inherited || hasOwnProperty$6$1.call(value, key)) &&
        !(skipIndexes && (
           // Safari 9 has enumerable `arguments.length` in strict mode.
           key == 'length' ||
           // Node.js 0.10 has enumerable non-index properties on buffers.
...
var _baseAssign$1 = baseAssign$1;
...
var _baseAssignIn$1 = baseAssignIn$1;
...
/** Built-in value references. */
var propertyIsEnumerable$1$1 = objectProto$11$1.propertyIsEnumerable;
...
var _copySymbols$1 = copySymbols$1;
 ...
 * @returns {Array} Returns the array of symbols.
 */
var getSymbolsIn$1 = !nativeGetSymbols$1$1 ? stubArray_1$1 : function(object) {
  var result = [];
  while (object) {
...
var _copySymbolsIn$1 = copySymbolsIn$1;
...
if ((_DataView$1 && getTag$1(new _DataView$1(new ArrayBuffer(1))) != dataViewTag$1$1) ||
    (_Map$1 && getTag$1(new _Map$1) != mapTag$1$1) ||
    (_Promise$1 && getTag$1(_Promise$1.resolve()) != promiseTag$1) ||
    (_Set$1 && getTag$1(new _Set$1) != setTag$1$1) ||
  ...
  getTag$1 = function(value) {
    ...
    if (ctorString) {
      switch (ctorString) {
        ...
        case mapCtorString$1: return mapTag$1$1;
        case promiseCtorString$1: return promiseTag$1;
        case setCtorString$1: return setTag$1$1;
...
function initCloneArray$1(array) {
  ...
  // Add properties assigned by `RegExp#exec`.
  if (length && typeof array[0] == 'string' && hasOwnProperty$9$1.call(array, 'index')) {
    result.index = array.index;
    result.input = array.input;
  }
  return result;
...
var _initCloneArray$1 = initCloneArray$1;
...
function cloneDataView$1(dataView, isDeep) {
  var buffer = isDeep ? _cloneArrayBuffer$1(dataView.buffer) : dataView.buffer;
  return new dataView.constructor(buffer, dataView.byteOffset, dataView.byteLength);
}

var _cloneDataView$1 = cloneDataView$1;
...
var _addMapEntry$1 = addMapEntry$1;
...
function cloneMap$1(map, isDeep, cloneFunc) {
  var array = isDeep ? cloneFunc(_mapToArray$1(map), CLONE_DEEP_FLAG$4) : _mapToArray$1(map);
  return _arrayReduce$1(array, _addMapEntry$1, new map.constructor);
}

var _cloneMap$1 = cloneMap$1;
...
var _cloneRegExp$1 = cloneRegExp$1;
...
var _addSetEntry$1 = addSetEntry$1;
...
function cloneSet$1(set, isDeep, cloneFunc) {
  var array = isDeep ? cloneFunc(_setToArray$1(set), CLONE_DEEP_FLAG$1$1) : _setToArray$1(set);
  return _arrayReduce$1(array, _addSetEntry$1, new set.constructor);
}

var _cloneSet$1 = cloneSet$1;
...
var _cloneSymbol$1 = cloneSymbol$1;
...
function initCloneByTag$1(object, tag, cloneFunc, isDeep) {
  ...
  switch (tag) {
    ...
    case float32Tag$1$1: case float64Tag$1$1:
    case int8Tag$1$1: case int16Tag$1$1: case int32Tag$1$1:
    case uint8Tag$1$1: case uint8ClampedTag$1$1: case uint16Tag$1$1: case uint32Tag$1$1:
      return _cloneTypedArray$1(object, isDeep);

    case mapTag$2$1:
      return _cloneMap$1(object, isDeep, cloneFunc);
    ...
    case setTag$2$1:
      return _cloneSet$1(object, isDeep, cloneFunc);
...
var _initCloneByTag$1 = initCloneByTag$1;
...
/** Used to identify `toStringTag` values supported by `_.clone`. */
var cloneableTags$1 = {};
cloneableTags$1[argsTag$2$1] = cloneableTags$1[arrayTag$1$1] =
cloneableTags$1[arrayBufferTag$2$1] = cloneableTags$1[dataViewTag$3$1] =
cloneableTags$1[boolTag$2$1] = cloneableTags$1[dateTag$2$1] =
cloneableTags$1[float32Tag$2$1] = cloneableTags$1[float64Tag$2$1] =
cloneableTags$1[int8Tag$2$1] = cloneableTags$1[int16Tag$2$1] =
cloneableTags$1[int32Tag$2$1] = cloneableTags$1[mapTag$3$1] =
cloneableTags$1[numberTag$2$1] = cloneableTags$1[objectTag$2$1] =
cloneableTags$1[regexpTag$2$1] = cloneableTags$1[setTag$3$1] =
cloneableTags$1[stringTag$2$1] = cloneableTags$1[symbolTag$1$1] =
cloneableTags$1[uint8Tag$2$1] = cloneableTags$1[uint8ClampedTag$2$1] =
cloneableTags$1[uint16Tag$2$1] = cloneableTags$1[uint32Tag$2$1] = true;
cloneableTags$1[errorTag$1$1] = cloneableTags$1[funcTag$2$1] =
cloneableTags$1[weakMapTag$2$1] = false;
...
function baseClone$1(value, bitmask, customizer, key, object, stack) {
  ...
  if (isArr) {
    ...
    if (tag == objectTag$2$1 || tag == argsTag$2$1 || (isFunc && !object)) {
      result = (isFlat || isFunc) ? {} : _initCloneObject$1(value);
      if (!isDeep) {
        return isFlat
          ? _copySymbolsIn$1(value, _baseAssignIn$1(result, value))
          : _copySymbols$1(value, _baseAssign$1(result, value));
      }
    } else {
      if (!cloneableTags$1[tag]) {
        return object ? value : {};
      }
      result = _initCloneByTag$1(value, tag, baseClone$1, isDeep);
    }
  }
  // Check for circular references and return its corresponding clone.
  ...
  var keysFunc = isFull
    ? (isFlat ? _getAllKeysIn$1 : _getAllKeys$1)
    : (isFlat ? keysIn : keys_1$1);

  var props = isArr ? undefined : keysFunc(value);
  _arrayEach$1(props || value, function(subValue, key) {
    if (props) {
      key = subValue;
      subValue = value[key];
    }
    // Recursively populate clone (susceptible to call stack limits).
    _assignValue$1(result, key, baseClone$1(subValue, bitmask, customizer, key, value, stack));
  });
  return result;
}

var _baseClone$1 = baseClone$1;
...
function cloneDeep$1(value) {
  return _baseClone$1(value, CLONE_DEEP_FLAG$3$1 | CLONE_SYMBOLS_FLAG$1$1);
}
...
function createInstance$1 (
  ...
  vm.$_mountingOptionsSlots = options.slots;
  vm.$_originalSlots = cloneDeep_1$1(vm.$slots);
  ...
  Object.keys(Vue$1).forEach(function (key) {
    if (!instance.hasOwnProperty(key)) {
      ...
      instance[key] = typeof original === 'object'
        ? cloneDeep_1$1(original)
        : original;
    }
  });

  // config is not enumerable
  instance.config = cloneDeep_1$1(Vue$1.config);
